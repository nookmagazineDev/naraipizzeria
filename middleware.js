 ...
 *
 * /api/branch-feed เป็นเส้นจ่ายทะเบียนสาขาให้โปรเจคอื่น (narai-storefct) ซึ่งเป็น
 * เซิร์ฟเวอร์ ไม่ใช่คน จึงไม่มีคุกกี้ล็อกอินมาด้วย — ตัวกันของเส้นนั้นคือกุญแจ
 * BRANCH_FEED_KEY ที่เทียบในตัว handler เอง ไม่ได้ตั้งกุญแจ = เส้นนั้นตอบ 503 ปิดตาย
 * (แพตเทิร์นเดียวกับ SHEETS_WRITE_KEY) ตรงนี้แค่ยกเว้นด่านคุกกี้ให้ผ่านไปถึง handler
 */
const PUBLIC_PATHS = ['/api/auth', '/api/branch-feed'];
