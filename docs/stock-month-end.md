...
2. **รายละเอียด** — กดที่แถวสาขา (หรือปุ่ม "ดูรายการของ<เดือน> ทุกสาขา") แล้วค่อยโหลดรายไอเทม
   ...
   **Export Excel**: คอลัมน์ "รหัสสินค้า" เติม 0 นำหน้าให้ครบ 8 หลักก่อนเขียนลงไฟล์
   (บางแถวเก็บมาแค่ 7 หลักเพราะ 0 นำหน้าหายตอนค่าผ่านช่องที่มองเป็นตัวเลข) และตั้งเซลล์
   เป็นชนิดข้อความ (`t='s'`, `z='@'`) ไม่งั้น Excel กิน 0 นำหน้าทิ้งตอนเปิดไฟล์อีกรอบ
   รหัสที่มีตัวอักษรปนไม่ถูกแตะ — ดู `padItemCode()` ใน `components/MonthEndList.jsx`
