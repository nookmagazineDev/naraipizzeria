...
// ทางที่ 1 เคยใช้ไม่ได้อยู่พักหนึ่ง (แพ็กเก็ตหายกลางทาง ขึ้น "Failed to connect ... in 15000ms"
// ไม่ใช่ถูกปฏิเสธ) ตอนนี้กลับมาใช้ได้แล้วและเป็นทางที่ใช้จริง — /api/qcrd ตอบ
// "via":"ต่อ SQL ตรง (inventory.dyndns.tv:1433/InventoryNarai)"
// ทางที่ 2 จึงเหลือไว้เป็นทางถอย เผื่อไฟร์วอลล์ที่ร้านเปลี่ยนแล้วพอร์ตนั้นไปไม่ถึงอีก
//
