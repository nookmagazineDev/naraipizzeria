...
g.__branchOutlet = g.__branchOutlet || { at: 0, ttl: 0, map: null, aliasKeys: null, fromFallback: false };
...
async function branchOutletCache() {
  ...
  try {
    ...
    if (Object.keys(m).length) {
      g.__branchOutlet = { at: Date.now(), ttl: TTL_MS, map: m, aliasKeys, fromFallback: false };
