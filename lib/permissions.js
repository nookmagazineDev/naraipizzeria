...
export const MENU_GROUPS = [
  ...
  },
  {
    key: 'stock', label: 'STOCK', items: [
      ...
      { key: 'stockUsagePerHead', label: 'รายงานการใช้วัตถุดิบต่อหัว' },
  ...
  },
  {
    key: 'hr', label: 'HR', items: [
      ...
      { key: 'uniformReport', label: 'ยูนิฟอร์ม' },
      { key: 'branchList', label: 'จัดการสาขา' },
      { key: 'branchUsers', label: 'login สาขา' },
    ],
  },
  {
...
/**
 * เมนูที่ห้ามแจกให้ใครนอกจาก admin
 * userList    = แจกสิทธิ์เข้าทุกเมนูของแดชบอร์ดได้
 * branchUsers = ตั้งรหัสผ่านให้บัญชีสาขาได้ ซึ่งเท่ากับเข้าระบบลงตารางงานในนามสาขานั้นได้
 */
export const ADMIN_ONLY_KEYS = ['userList', 'branchUsers'];
