// แปลงแถวจากชีท -> เรคคอร์ด + คำสั่ง SQL สำหรับย้าย แพลนสั่งของ · ปิดรอบสิ้นเดือน · ค่าใช้จ่ายอื่นๆ
//
...
//
// พนักงานไม่อยู่ในนี้แล้ว: รายชื่อย้ายไปรวมที่ narai_hr.dbo.hr_employee ซึ่งเป็นตารางเดียวกับที่
// ตารางงาน/กะ ใช้ และถูกแก้จากหน้าเว็บทุกวัน — ย้ายจากชีททับซ้ำอีกจะเอาข้อมูลเก่ากลับมาทับของจริง
// (ดู docs/schema-hr-employee.sql)
