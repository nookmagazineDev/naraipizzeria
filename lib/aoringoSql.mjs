...
const BILL_FIELDS = {
  ...
  vatIncluded: ['VatIncluded', 'TaxIncluded', 'IncludeVat'],
  received:  ['ReceivedAmount', 'Received', 'CashReceived'],
  changeAmount: ['ChangeAmount', 'Change'],
...
export function buildAppPlan(app) {
  ...
  const billCols = [
    ...
    // ใบกำกับภาษี (อย่างย่อ/เต็มรูป) ต้องบอกอัตราภาษีและว่าราคารวมภาษีไว้แล้วหรือยัง
    pickAs(o, 'o', ['VatRate'], 'vatRate'),
    pickAs(o, 'o', ['VatIncluded'], 'vatIncluded'),
    pickAs(o, 'o', ['ReceivedAmount'], 'received'),
    pickAs(o, 'o', ['ChangeAmount'], 'changeAmount'),
